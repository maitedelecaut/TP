...
check(cours is not null), check(creneauD is not null), check(creneauF is not null), check(pno_Eleve is not null), check(pno_Prof is not null), check(numJ is not null), check (date is not null),
...
create table Justif(numJ Serial, text Text, dateD Date, dateF Date, pno_Eleve integer, pno_Prof integer, check(pno_Eleve is not null), check(pno_Prof is not null), check(dateD is not null), check(dateF is not null),
